...
namespace Llvm.NET.DebugInfo
{
    ...
    /// </summary>
    /// <remarks>
    /// <para>Function signatures are unnamed uniqued types in LLVM. While there is usually a one
    ...
    /// souce function where a pointer to the structure is actually used in the source.</para>
