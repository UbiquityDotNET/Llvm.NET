...
namespace LlvmHandleGenerator
{
    ...
    {
        internal static readonly AttributeNames ContextHandleAttribute = new("Ubiquity.NET.Llvm.Interop.Handles", "ContextHandleAttribute");
        internal static readonly AttributeNames GlobalHandleAttribute = new("Ubiquity.NET.Llvm.Interop.Handles", "GlobalHandleAttribute");
    }
}
