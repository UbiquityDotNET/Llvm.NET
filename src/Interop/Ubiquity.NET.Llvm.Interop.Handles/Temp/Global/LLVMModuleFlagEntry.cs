// -----------------------------------------------------------------------
// <copyright file="LLVMModuleFlagEntry.cs" company="Ubiquity.NET Contributors">
...
namespace Ubiquity.NET.Llvm.Interop.Handles
{
    ...
    public class LLVMModuleFlagEntry
        : GlobalHandleBase
    {
        /// <summary>Initializes an instance of <see cref="LLVMModuleFlagEntry"/> with default values</summary>
        public LLVMModuleFlagEntry()
            : base( ownsHandle: true )
        {
        }

        /// <summary>Initializes an instance of <see cref="LLVMModuleFlagEntry"/></summary>
        ...
        public LLVMModuleFlagEntry(nint handle, bool owner)
            : base( owner )
        {
            SetHandle( handle );
        }
        ...
        public static LLVMModuleFlagEntry Zero { get; } = new LLVMModuleFlagEntry( nint.Zero, false );
        ...
        protected override bool ReleaseHandle()
        {
            ...
            static extern void LLVMDisposeModuleFlagsMetadata(nint p);
        }
    }
}
