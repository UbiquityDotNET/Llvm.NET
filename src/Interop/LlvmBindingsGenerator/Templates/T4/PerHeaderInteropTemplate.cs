...
foreach(var p in FunctionPointers) {
            
            #line default
            #line hidden
            this.Write("    using unsafe ");
...
foreach(var fld in InlinedArrayFields){
            
            #line default
            #line hidden
            this.Write("    [InlineArray(");
            
            #line 39 "D:\GitHub\Ubiquity.NET\Llvm.Net\src\Interop\LlvmBindingsGenerator\Templates\T4\PerHeaderInteropTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(InlinedArraySize(fld)));
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(GetManagedTypeName(fld)));
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(GetInlinedArrayElementType(fld)));
...
if(HasNativeMethods){
    ...
    foreach(var f in Functions) {
        ...
        foreach(var a in f.Attributes) {
            ...
            #line default
            #line hidden
            this.Write("        public static unsafe partial ");
