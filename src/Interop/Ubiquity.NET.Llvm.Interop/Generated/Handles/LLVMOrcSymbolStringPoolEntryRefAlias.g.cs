...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(ContextHandleMarshaller<LLVMOrcSymbolStringPoolEntryRefAlias>))]
    public readonly record struct LLVMOrcSymbolStringPoolEntryRefAlias
        : IContextHandle<LLVMOrcSymbolStringPoolEntryRefAlias>
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMOrcSymbolStringPoolEntryRefAlias"/></summary>
        ...
        public static LLVMOrcSymbolStringPoolEntryRefAlias FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets a zero (<see langword="null"/>) value handle</summary>
        public static LLVMOrcSymbolStringPoolEntryRefAlias Zero => FromABI(nint.Zero);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMOrcSymbolStringPoolEntryRefAlias value) => value.Handle;

        private LLVMOrcSymbolStringPoolEntryRefAlias( nint p )
        {
            Handle = p;
        }
