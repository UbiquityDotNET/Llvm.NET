...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOrcSymbolStringPoolEntryRefAlias>))]
    public readonly record struct LLVMOrcSymbolStringPoolEntryRefAlias
        : IWrappedHandle<LLVMOrcSymbolStringPoolEntryRefAlias>
        , IFormattable
    {
        ...
        internal LLVMOrcSymbolStringPoolEntryRefAlias( nint p )
        {
            Handle = p;
        }
