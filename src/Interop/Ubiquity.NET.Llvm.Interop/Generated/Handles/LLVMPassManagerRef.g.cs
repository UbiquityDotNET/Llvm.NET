...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMPassManagerRef>))]
    public readonly record struct LLVMPassManagerRef
        : IWrappedHandle<LLVMPassManagerRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMPassManagerRef"/></summary>
        ...
        public static LLVMPassManagerRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMPassManagerRef value) => value.Handle;
        ...
        internal LLVMPassManagerRef( nint p )
        {
            Handle = p;
#if DEBUG
