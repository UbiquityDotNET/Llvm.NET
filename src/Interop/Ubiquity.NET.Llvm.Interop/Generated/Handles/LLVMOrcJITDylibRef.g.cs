...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOrcJITDylibRef>))]
    public readonly record struct LLVMOrcJITDylibRef
        : IWrappedHandle<LLVMOrcJITDylibRef>
        , IFormattable
    {
        ...
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMOrcJITDylibRef value) => value.Handle;

        internal LLVMOrcJITDylibRef( nint p )
        {
            Handle = p;
        }
