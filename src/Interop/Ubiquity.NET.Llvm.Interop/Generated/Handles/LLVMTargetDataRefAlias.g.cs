...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(ContextHandleMarshaller<LLVMTargetDataRefAlias>))]
    public readonly record struct LLVMTargetDataRefAlias
        : IContextHandle<LLVMTargetDataRefAlias>
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMTargetDataRefAlias"/></summary>
        ...
        public static LLVMTargetDataRefAlias FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets a zero (<see langword="null"/>) value handle</summary>
        public static LLVMTargetDataRefAlias Zero => FromABI(nint.Zero);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMTargetDataRefAlias value) => value.Handle;

        private LLVMTargetDataRefAlias( nint p )
        {
            Handle = p;
        }
