...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMSectionIteratorRef>))]
    public readonly record struct LLVMSectionIteratorRef
        : IWrappedHandle<LLVMSectionIteratorRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMSectionIteratorRef"/></summary>
        ...
        public static LLVMSectionIteratorRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMSectionIteratorRef value) => value.Handle;
        ...
        internal LLVMSectionIteratorRef( nint p )
        {
            Handle = p;
#if DEBUG
