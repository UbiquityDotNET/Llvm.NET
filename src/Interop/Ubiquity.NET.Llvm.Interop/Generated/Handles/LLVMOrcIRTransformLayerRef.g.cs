...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOrcIRTransformLayerRef>))]
    public readonly record struct LLVMOrcIRTransformLayerRef
        : IWrappedHandle<LLVMOrcIRTransformLayerRef>
        , IFormattable
    {
        ...
        internal LLVMOrcIRTransformLayerRef( nint p )
        {
            Handle = p;
        }
