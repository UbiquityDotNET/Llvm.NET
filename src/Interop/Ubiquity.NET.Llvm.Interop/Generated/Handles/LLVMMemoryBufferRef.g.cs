...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMMemoryBufferRef>))]
    public readonly record struct LLVMMemoryBufferRef
        : IWrappedHandle<LLVMMemoryBufferRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMMemoryBufferRef"/></summary>
        ...
        public static LLVMMemoryBufferRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMMemoryBufferRef value) => value.Handle;
        ...
        public void Dispose( )
        {
            ...
            static unsafe extern void LLVMDisposeMemoryBuffer( nint p );
        }

        internal LLVMMemoryBufferRef( nint p )
        {
            Handle = p;
#if DEBUG
