...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(ContextHandleMarshaller<LLVMModuleRefAlias>))]
    public readonly record struct LLVMModuleRefAlias
        : IContextHandle<LLVMModuleRefAlias>
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMModuleRefAlias"/></summary>
        ...
        public static LLVMModuleRefAlias FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets a zero (<see langword="null"/>) value handle</summary>
        public static LLVMModuleRefAlias Zero => FromABI(nint.Zero);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMModuleRefAlias value) => value.Handle;

        private LLVMModuleRefAlias( nint p )
        {
            Handle = p;
        }
