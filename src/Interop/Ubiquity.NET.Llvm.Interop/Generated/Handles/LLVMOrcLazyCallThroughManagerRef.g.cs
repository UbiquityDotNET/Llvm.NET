...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOrcLazyCallThroughManagerRef>))]
    public readonly record struct LLVMOrcLazyCallThroughManagerRef
        : IWrappedHandle<LLVMOrcLazyCallThroughManagerRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMOrcLazyCallThroughManagerRef"/></summary>
        ...
        public static LLVMOrcLazyCallThroughManagerRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMOrcLazyCallThroughManagerRef value) => value.Handle;
        ...
        internal LLVMOrcLazyCallThroughManagerRef( nint p )
        {
            Handle = p;
#if DEBUG
