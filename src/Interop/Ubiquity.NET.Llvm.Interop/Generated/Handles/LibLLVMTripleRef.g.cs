...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LibLLVMTripleRef>))]
    public readonly record struct LibLLVMTripleRef
        : IWrappedHandle<LibLLVMTripleRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LibLLVMTripleRef"/></summary>
        ...
        public static LibLLVMTripleRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LibLLVMTripleRef value) => value.Handle;
        ...
        public void Dispose( )
        {
            ...
            static unsafe extern void LibLLVMDisposeTriple( nint p );
        }

        internal LibLLVMTripleRef( nint p )
        {
            Handle = p;
#if DEBUG
