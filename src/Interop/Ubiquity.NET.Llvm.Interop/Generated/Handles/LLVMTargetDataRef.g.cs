...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMTargetDataRef>))]
    public readonly record struct LLVMTargetDataRef
        : IWrappedHandle<LLVMTargetDataRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMTargetDataRef"/></summary>
        ...
        public static LLVMTargetDataRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMTargetDataRef value) => value.Handle;
        ...
        public static implicit operator LLVMTargetDataRefAlias(LLVMTargetDataRef self) => new(self.Handle);

        internal LLVMTargetDataRef( nint p )
        {
            Handle = p;
#if DEBUG
