...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMSymbolIteratorRef>))]
    public readonly record struct LLVMSymbolIteratorRef
        : IWrappedHandle<LLVMSymbolIteratorRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMSymbolIteratorRef"/></summary>
        ...
        public static LLVMSymbolIteratorRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMSymbolIteratorRef value) => value.Handle;
        ...
        internal LLVMSymbolIteratorRef( nint p )
        {
            Handle = p;
#if DEBUG
