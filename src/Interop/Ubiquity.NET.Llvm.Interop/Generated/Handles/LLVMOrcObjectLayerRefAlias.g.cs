...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(ContextHandleMarshaller<LLVMOrcObjectLayerRefAlias>))]
    public readonly record struct LLVMOrcObjectLayerRefAlias
        : IContextHandle<LLVMOrcObjectLayerRefAlias>
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMOrcObjectLayerRefAlias"/></summary>
        ...
        public static LLVMOrcObjectLayerRefAlias FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets a zero (<see langword="null"/>) value handle</summary>
        public static LLVMOrcObjectLayerRefAlias Zero => FromABI(nint.Zero);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMOrcObjectLayerRefAlias value) => value.Handle;

        private LLVMOrcObjectLayerRefAlias( nint p )
        {
            Handle = p;
        }
