...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOrcObjectLayerRefAlias>))]
    public readonly record struct LLVMOrcObjectLayerRefAlias
        : IWrappedHandle<LLVMOrcObjectLayerRefAlias>
        , IFormattable
    {
        ...
        internal LLVMOrcObjectLayerRefAlias( nint p )
        {
            Handle = p;
        }
