...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOrcDefinitionGeneratorRef>))]
    public readonly record struct LLVMOrcDefinitionGeneratorRef
        : IWrappedHandle<LLVMOrcDefinitionGeneratorRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMOrcDefinitionGeneratorRef"/></summary>
        ...
        public static LLVMOrcDefinitionGeneratorRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMOrcDefinitionGeneratorRef value) => value.Handle;
        ...
        public void Dispose( )
        {
            ...
            static unsafe extern void LLVMOrcDisposeDefinitionGenerator( nint p );
        }

        internal LLVMOrcDefinitionGeneratorRef( nint p )
        {
            Handle = p;
#if DEBUG
