...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    public class LLVMOrcDefinitionGeneratorRef
        : GlobalHandleBase
        , IEquatable<LLVMOrcDefinitionGeneratorRef>
    {
        ...
        public bool Equals(LLVMOrcDefinitionGeneratorRef? other) => other is not null && handle == other.handle;

        public override bool Equals(object? obj) => obj is LLVMOrcDefinitionGeneratorRef hOther && Equals(hOther);
