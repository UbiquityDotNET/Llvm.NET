...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMValueMetadataEntry>))]
    public readonly record struct LLVMValueMetadataEntry
        : IWrappedHandle<LLVMValueMetadataEntry>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMValueMetadataEntry"/></summary>
        ...
        public static LLVMValueMetadataEntry FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMValueMetadataEntry value) => value.Handle;
        ...
        internal LLVMValueMetadataEntry( nint p )
        {
            Handle = p;
#if DEBUG
