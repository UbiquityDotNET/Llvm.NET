...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOrcIndirectStubsManagerRef>))]
    public readonly record struct LLVMOrcIndirectStubsManagerRef
        : IWrappedHandle<LLVMOrcIndirectStubsManagerRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMOrcIndirectStubsManagerRef"/></summary>
        ...
        public static LLVMOrcIndirectStubsManagerRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMOrcIndirectStubsManagerRef value) => value.Handle;
        ...
        internal LLVMOrcIndirectStubsManagerRef( nint p )
        {
            Handle = p;
#if DEBUG
