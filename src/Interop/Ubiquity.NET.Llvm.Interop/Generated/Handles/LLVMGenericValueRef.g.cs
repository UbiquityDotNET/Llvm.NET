...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    public class LLVMGenericValueRef
        : GlobalHandleBase
        , IEquatable<LLVMGenericValueRef>
    {
        ...
        public bool Equals(LLVMGenericValueRef? other) => other is not null && handle == other.handle;

        public override bool Equals(object? obj) => obj is LLVMGenericValueRef hOther && Equals(hOther);
