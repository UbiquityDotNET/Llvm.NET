...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMGenericValueRef>))]
    public readonly record struct LLVMGenericValueRef
        : IWrappedHandle<LLVMGenericValueRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMGenericValueRef"/></summary>
        ...
        public static LLVMGenericValueRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMGenericValueRef value) => value.Handle;
        ...
        public void Dispose( )
        {
            ...
            static unsafe extern void LLVMDisposeGenericValue( nint p );
        }

        internal LLVMGenericValueRef( nint p )
        {
            Handle = p;
#if DEBUG
