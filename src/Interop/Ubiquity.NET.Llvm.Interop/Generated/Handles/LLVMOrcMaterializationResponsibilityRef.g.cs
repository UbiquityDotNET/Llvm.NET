...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOrcMaterializationResponsibilityRef>))]
    public readonly record struct LLVMOrcMaterializationResponsibilityRef
        : IWrappedHandle<LLVMOrcMaterializationResponsibilityRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMOrcMaterializationResponsibilityRef"/></summary>
        ...
        public static LLVMOrcMaterializationResponsibilityRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMOrcMaterializationResponsibilityRef value) => value.Handle;
        ...
        internal LLVMOrcMaterializationResponsibilityRef( nint p )
        {
            Handle = p;
#if DEBUG
