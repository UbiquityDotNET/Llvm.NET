...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LibLLVMComdatIteratorRef>))]
    public readonly record struct LibLLVMComdatIteratorRef
        : IWrappedHandle<LibLLVMComdatIteratorRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LibLLVMComdatIteratorRef"/></summary>
        ...
        public static LibLLVMComdatIteratorRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LibLLVMComdatIteratorRef value) => value.Handle;
        ...
        internal LibLLVMComdatIteratorRef( nint p )
        {
            Handle = p;
#if DEBUG
