...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOrcThreadSafeContextRef>))]
    public readonly record struct LLVMOrcThreadSafeContextRef
        : IWrappedHandle<LLVMOrcThreadSafeContextRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMOrcThreadSafeContextRef"/></summary>
        ...
        public static LLVMOrcThreadSafeContextRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMOrcThreadSafeContextRef value) => value.Handle;
        ...
        public void Dispose( )
        {
            ...
            static unsafe extern void LLVMOrcDisposeThreadSafeContext( nint p );
        }

        internal LLVMOrcThreadSafeContextRef( nint p )
        {
            Handle = p;
#if DEBUG
