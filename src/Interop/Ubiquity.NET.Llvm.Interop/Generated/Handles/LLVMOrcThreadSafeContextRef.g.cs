...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    public class LLVMOrcThreadSafeContextRef
        : GlobalHandleBase
        , IEquatable<LLVMOrcThreadSafeContextRef>
    {
        ...
        public bool Equals(LLVMOrcThreadSafeContextRef? other) => other is not null && handle == other.handle;

        public override bool Equals(object? obj) => obj is LLVMOrcThreadSafeContextRef hOther && Equals(hOther);
