...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    public class LLVMOrcJITTargetMachineBuilderRef
        : GlobalHandleBase
        , IEquatable<LLVMOrcJITTargetMachineBuilderRef>
    {
        ...
        public bool Equals(LLVMOrcJITTargetMachineBuilderRef? other) => other is not null && handle == other.handle;

        public override bool Equals(object? obj) => obj is LLVMOrcJITTargetMachineBuilderRef hOther && Equals(hOther);
