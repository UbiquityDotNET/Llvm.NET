...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOrcJITTargetMachineBuilderRef>))]
    public readonly record struct LLVMOrcJITTargetMachineBuilderRef
        : IWrappedHandle<LLVMOrcJITTargetMachineBuilderRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMOrcJITTargetMachineBuilderRef"/></summary>
        ...
        public static LLVMOrcJITTargetMachineBuilderRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMOrcJITTargetMachineBuilderRef value) => value.Handle;
        ...
        public void Dispose( )
        {
            ...
            static unsafe extern void LLVMOrcDisposeJITTargetMachineBuilder( nint p );
        }

        internal LLVMOrcJITTargetMachineBuilderRef( nint p )
        {
            Handle = p;
#if DEBUG
