...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOrcThreadSafeModuleRef>))]
    public readonly record struct LLVMOrcThreadSafeModuleRef
        : IWrappedHandle<LLVMOrcThreadSafeModuleRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMOrcThreadSafeModuleRef"/></summary>
        ...
        public static LLVMOrcThreadSafeModuleRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMOrcThreadSafeModuleRef value) => value.Handle;
        ...
        internal LLVMOrcThreadSafeModuleRef( nint p )
        {
            Handle = p;
#if DEBUG
