...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOrcLLJITRef>))]
    public readonly record struct LLVMOrcLLJITRef
        : IWrappedHandle<LLVMOrcLLJITRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMOrcLLJITRef"/></summary>
        ...
        public static LLVMOrcLLJITRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMOrcLLJITRef value) => value.Handle;
        ...
        internal LLVMOrcLLJITRef( nint p )
        {
            Handle = p;
#if DEBUG
