...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOrcExecutionSessionRef>))]
    public readonly record struct LLVMOrcExecutionSessionRef
        : IWrappedHandle<LLVMOrcExecutionSessionRef>
        , IFormattable
    {
        ...
        internal LLVMOrcExecutionSessionRef( nint p )
        {
            Handle = p;
        }
