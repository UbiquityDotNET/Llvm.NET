...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMRelocationIteratorRef>))]
    public readonly record struct LLVMRelocationIteratorRef
        : IWrappedHandle<LLVMRelocationIteratorRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMRelocationIteratorRef"/></summary>
        ...
        public static LLVMRelocationIteratorRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMRelocationIteratorRef value) => value.Handle;
        ...
        internal LLVMRelocationIteratorRef( nint p )
        {
            Handle = p;
#if DEBUG
