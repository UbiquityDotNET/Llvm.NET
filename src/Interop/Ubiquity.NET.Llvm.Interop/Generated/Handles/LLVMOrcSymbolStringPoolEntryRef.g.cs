...
//     Tool Version: 20.1.11-alpha.1.0.ci.620858027.ZZZ
//
...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    /// </note>
    /// </remarks>
    [GeneratedCode("LlvmBindingsGenerator","20.1.11-alpha.1.0.ci.620858027.ZZZ")]
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOrcSymbolStringPoolEntryRef>))]
    public readonly record struct LLVMOrcSymbolStringPoolEntryRef
        : IWrappedHandle<LLVMOrcSymbolStringPoolEntryRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMOrcSymbolStringPoolEntryRef"/></summary>
        ...
        public static LLVMOrcSymbolStringPoolEntryRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMOrcSymbolStringPoolEntryRef value) => value.Handle;
        ...
        public static implicit operator LLVMOrcSymbolStringPoolEntryRefAlias(LLVMOrcSymbolStringPoolEntryRef self) => new(self.Handle);

        internal LLVMOrcSymbolStringPoolEntryRef( nint p )
        {
            Handle = p;
#if DEBUG
