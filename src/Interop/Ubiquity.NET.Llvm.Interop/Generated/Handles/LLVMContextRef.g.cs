...
namespace Ubiquity.NET.Llvm.Interop
{
        ...
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMContextRef"/></summary>
        ...
        public static LLVMContextRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMContextRef value) => value.Handle;
        ...
        public static implicit operator LLVMContextRefAlias(LLVMContextRef self) => new(self.Handle);

        internal LLVMContextRef( nint p )
        {
            Handle = p;
#if DEBUG
