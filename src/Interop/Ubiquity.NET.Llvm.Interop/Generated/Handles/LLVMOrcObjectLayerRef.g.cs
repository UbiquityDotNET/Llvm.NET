...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    public class LLVMOrcObjectLayerRef
        : GlobalHandleBase
        , IEquatable<LLVMOrcObjectLayerRef>
    {
        ...
        public bool Equals(LLVMOrcObjectLayerRef? other) => other is not null && handle == other.handle;

        public override bool Equals(object? obj) => obj is LLVMOrcObjectLayerRef hOther && Equals(hOther);
        ...
        public static implicit operator LLVMOrcObjectLayerRefAlias(LLVMOrcObjectLayerRef self)
        {
            ArgumentNullException.ThrowIfNull(self);
            self.ThrowIfInvalid();
            return LLVMOrcObjectLayerRefAlias.FromABI(self.DangerousGetHandle());
        }
