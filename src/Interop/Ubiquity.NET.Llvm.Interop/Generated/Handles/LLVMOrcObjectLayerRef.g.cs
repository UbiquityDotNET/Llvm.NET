...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOrcObjectLayerRef>))]
    public readonly record struct LLVMOrcObjectLayerRef
        : IWrappedHandle<LLVMOrcObjectLayerRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMOrcObjectLayerRef"/></summary>
        ...
        public static LLVMOrcObjectLayerRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMOrcObjectLayerRef value) => value.Handle;
        ...
        public void Dispose( )
        {
            ...
            static unsafe extern void LLVMOrcDisposeObjectLayer( nint p );
        }
    
        public static implicit operator LLVMOrcObjectLayerRefAlias(LLVMOrcObjectLayerRef self) => new(self.Handle);

        internal LLVMOrcObjectLayerRef( nint p )
        {
            Handle = p;
#if DEBUG
