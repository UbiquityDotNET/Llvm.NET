...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(ContextHandleMarshaller<LLVMTargetMachineRefAlias>))]
    public readonly record struct LLVMTargetMachineRefAlias
        : IContextHandle<LLVMTargetMachineRefAlias>
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMTargetMachineRefAlias"/></summary>
        ...
        public static LLVMTargetMachineRefAlias FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets a zero (<see langword="null"/>) value handle</summary>
        public static LLVMTargetMachineRefAlias Zero => FromABI(nint.Zero);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMTargetMachineRefAlias value) => value.Handle;

        private LLVMTargetMachineRefAlias( nint p )
        {
            Handle = p;
        }
