...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMTargetMachineRefAlias>))]
    public readonly record struct LLVMTargetMachineRefAlias
        : IWrappedHandle<LLVMTargetMachineRefAlias>
        , IFormattable
    {
        ...
        internal LLVMTargetMachineRefAlias( nint p )
        {
            Handle = p;
        }
