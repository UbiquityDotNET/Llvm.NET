...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOrcObjectTransformLayerRef>))]
    public readonly record struct LLVMOrcObjectTransformLayerRef
        : IWrappedHandle<LLVMOrcObjectTransformLayerRef>
        , IFormattable
    {
        ...
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMOrcObjectTransformLayerRef value) => value.Handle;

        internal LLVMOrcObjectTransformLayerRef( nint p )
        {
            Handle = p;
        }
