...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMTargetLibraryInfoRef>))]
    public readonly record struct LLVMTargetLibraryInfoRef
        : IWrappedHandle<LLVMTargetLibraryInfoRef>
        , IFormattable
    {
        ...
        internal LLVMTargetLibraryInfoRef( nint p )
        {
            Handle = p;
        }
