...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMExecutionEngineRef>))]
    public readonly record struct LLVMExecutionEngineRef
        : IWrappedHandle<LLVMExecutionEngineRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMExecutionEngineRef"/></summary>
        ...
        public static LLVMExecutionEngineRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMExecutionEngineRef value) => value.Handle;
        ...
        public void Dispose( )
        {
            ...
            static unsafe extern void LLVMDisposeExecutionEngine( nint p );
        }

        internal LLVMExecutionEngineRef( nint p )
        {
            Handle = p;
#if DEBUG
