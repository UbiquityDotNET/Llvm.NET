...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOrcMaterializationUnitRef>))]
    public readonly record struct LLVMOrcMaterializationUnitRef
        : IWrappedHandle<LLVMOrcMaterializationUnitRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMOrcMaterializationUnitRef"/></summary>
        ...
        public static LLVMOrcMaterializationUnitRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMOrcMaterializationUnitRef value) => value.Handle;
        ...
        internal LLVMOrcMaterializationUnitRef( nint p )
        {
            Handle = p;
#if DEBUG
