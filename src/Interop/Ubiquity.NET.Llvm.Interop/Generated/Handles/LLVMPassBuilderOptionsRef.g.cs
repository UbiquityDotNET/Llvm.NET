...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMPassBuilderOptionsRef>))]
    public readonly record struct LLVMPassBuilderOptionsRef
        : IWrappedHandle<LLVMPassBuilderOptionsRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMPassBuilderOptionsRef"/></summary>
        ...
        public static LLVMPassBuilderOptionsRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMPassBuilderOptionsRef value) => value.Handle;
        ...
        internal LLVMPassBuilderOptionsRef( nint p )
        {
            Handle = p;
#if DEBUG
