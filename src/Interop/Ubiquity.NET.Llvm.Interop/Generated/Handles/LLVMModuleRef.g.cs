...
namespace Ubiquity.NET.Llvm.Interop
{
        ...
        , IEquatable<LLVMModuleRef>
    {
        ...
        public bool Equals(LLVMModuleRef? other) => other is not null && handle == other.handle;

        public override bool Equals(object? obj) => obj is LLVMModuleRef hOther && Equals(hOther);
        ...
        public static implicit operator LLVMModuleRefAlias(LLVMModuleRef self)
        {
            ArgumentNullException.ThrowIfNull(self);
            self.ThrowIfInvalid();
            return LLVMModuleRefAlias.FromABI(self.DangerousGetHandle());
        }
