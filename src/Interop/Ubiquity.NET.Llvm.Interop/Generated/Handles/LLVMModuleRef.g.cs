...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMModuleRef>))]
    public readonly record struct LLVMModuleRef
        : IWrappedHandle<LLVMModuleRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMModuleRef"/></summary>
        ...
        public static LLVMModuleRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMModuleRef value) => value.Handle;
        ...
        public void Dispose( )
        {
            ...
            static unsafe extern void LLVMDisposeModule( nint p );
        }
    
        public static implicit operator LLVMModuleRefAlias(LLVMModuleRef self) => new(self.Handle);

        internal LLVMModuleRef( nint p )
        {
            Handle = p;
#if DEBUG
