...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOrcLLJITBuilderRef>))]
    public readonly record struct LLVMOrcLLJITBuilderRef
        : IWrappedHandle<LLVMOrcLLJITBuilderRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMOrcLLJITBuilderRef"/></summary>
        ...
        public static LLVMOrcLLJITBuilderRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMOrcLLJITBuilderRef value) => value.Handle;
        ...
        internal LLVMOrcLLJITBuilderRef( nint p )
        {
            Handle = p;
#if DEBUG
