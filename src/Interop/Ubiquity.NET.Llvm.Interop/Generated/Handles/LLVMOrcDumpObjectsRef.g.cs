...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOrcDumpObjectsRef>))]
    public readonly record struct LLVMOrcDumpObjectsRef
        : IWrappedHandle<LLVMOrcDumpObjectsRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMOrcDumpObjectsRef"/></summary>
        ...
        public static LLVMOrcDumpObjectsRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMOrcDumpObjectsRef value) => value.Handle;
        ...
        public void Dispose( )
        {
            ...
            static unsafe extern void LLVMOrcDisposeDumpObjects( nint p );
        }

        internal LLVMOrcDumpObjectsRef( nint p )
        {
            Handle = p;
#if DEBUG
