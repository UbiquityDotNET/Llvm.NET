...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    public class LLVMOrcDumpObjectsRef
        : GlobalHandleBase
        , IEquatable<LLVMOrcDumpObjectsRef>
    {
        ...
        public bool Equals(LLVMOrcDumpObjectsRef? other) => other is not null && handle == other.handle;

        public override bool Equals(object? obj) => obj is LLVMOrcDumpObjectsRef hOther && Equals(hOther);
