...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMObjectFileRef>))]
    public readonly record struct LLVMObjectFileRef
        : IWrappedHandle<LLVMObjectFileRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMObjectFileRef"/></summary>
        ...
        public static LLVMObjectFileRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMObjectFileRef value) => value.Handle;
        ...
        internal LLVMObjectFileRef( nint p )
        {
            Handle = p;
#if DEBUG
