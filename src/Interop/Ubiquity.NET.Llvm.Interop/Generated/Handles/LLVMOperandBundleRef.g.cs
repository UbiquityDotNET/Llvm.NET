...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOperandBundleRef>))]
    public readonly record struct LLVMOperandBundleRef
        : IWrappedHandle<LLVMOperandBundleRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMOperandBundleRef"/></summary>
        ...
        public static LLVMOperandBundleRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMOperandBundleRef value) => value.Handle;
        ...
        internal LLVMOperandBundleRef( nint p )
        {
            Handle = p;
#if DEBUG
