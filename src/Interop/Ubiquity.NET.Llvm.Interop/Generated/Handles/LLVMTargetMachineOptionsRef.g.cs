...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMTargetMachineOptionsRef>))]
    public readonly record struct LLVMTargetMachineOptionsRef
        : IWrappedHandle<LLVMTargetMachineOptionsRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMTargetMachineOptionsRef"/></summary>
        ...
        public static LLVMTargetMachineOptionsRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMTargetMachineOptionsRef value) => value.Handle;
        ...
        internal LLVMTargetMachineOptionsRef( nint p )
        {
            Handle = p;
#if DEBUG
