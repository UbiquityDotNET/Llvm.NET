...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMModuleFlagEntry>))]
    public readonly record struct LLVMModuleFlagEntry
        : IWrappedHandle<LLVMModuleFlagEntry>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMModuleFlagEntry"/></summary>
        ...
        public static LLVMModuleFlagEntry FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMModuleFlagEntry value) => value.Handle;
        ...
        internal LLVMModuleFlagEntry( nint p )
        {
            Handle = p;
#if DEBUG
