...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMTargetMachineRef>))]
    public readonly record struct LLVMTargetMachineRef
        : IWrappedHandle<LLVMTargetMachineRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMTargetMachineRef"/></summary>
        ...
        public static LLVMTargetMachineRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMTargetMachineRef value) => value.Handle;
        ...
        public static implicit operator LLVMTargetMachineRefAlias(LLVMTargetMachineRef self) => new(self.Handle);

        internal LLVMTargetMachineRef( nint p )
        {
            Handle = p;
#if DEBUG
