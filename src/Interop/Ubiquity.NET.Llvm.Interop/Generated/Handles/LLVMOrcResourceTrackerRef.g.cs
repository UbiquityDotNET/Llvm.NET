...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOrcResourceTrackerRef>))]
    public readonly record struct LLVMOrcResourceTrackerRef
        : IWrappedHandle<LLVMOrcResourceTrackerRef>
        , IFormattable
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMOrcResourceTrackerRef"/></summary>
        ...
        public static LLVMOrcResourceTrackerRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMOrcResourceTrackerRef value) => value.Handle;
        ...
        internal LLVMOrcResourceTrackerRef( nint p )
        {
            Handle = p;
#if DEBUG
