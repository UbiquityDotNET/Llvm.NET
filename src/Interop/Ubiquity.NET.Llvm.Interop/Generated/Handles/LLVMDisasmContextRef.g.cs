...
namespace Ubiquity.NET.Llvm.Interop
{
        ...
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMDisasmContextRef"/></summary>
        ...
        public static LLVMDisasmContextRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMDisasmContextRef value) => value.Handle;
        ...
        public void Dispose( )
        {
            ...
            static unsafe extern void LLVMDisasmDispose( nint p );
        }

        internal LLVMDisasmContextRef( nint p )
        {
            Handle = p;
#if DEBUG
