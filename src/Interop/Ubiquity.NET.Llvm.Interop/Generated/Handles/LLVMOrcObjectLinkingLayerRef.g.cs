...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    [NativeMarshalling(typeof(WrappedHandleMarshaller<LLVMOrcObjectLinkingLayerRef>))]
    public readonly record struct LLVMOrcObjectLinkingLayerRef
        : IWrappedHandle<LLVMOrcObjectLinkingLayerRef>
        , IFormattable
    {
        ...
        internal LLVMOrcObjectLinkingLayerRef( nint p )
        {
            Handle = p;
        }
