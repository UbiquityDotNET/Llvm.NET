...
namespace Ubiquity.NET.Llvm.Interop
{
        ...
        , IDisposable
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMDIBuilderRef"/></summary>
        ...
        public static LLVMDIBuilderRef FromABI(nint abiValue) => new(abiValue);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMDIBuilderRef value) => value.Handle;
        ...
        internal LLVMDIBuilderRef( nint p )
        {
            Handle = p;
#if DEBUG
