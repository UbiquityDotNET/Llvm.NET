// -----------------------------------------------------------------------
// <copyright file="LLVMOrcLookupStateRef.cs" company="Ubiquity.NET Contributors">
...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    /// </note>
    /// </remarks>
    [NativeMarshalling( typeof( ContextHandleMarshaller<LLVMOrcLookupStateRef> ) )]
    public readonly record struct LLVMOrcLookupStateRef
        : IContextHandle<LLVMOrcLookupStateRef>
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMOrcLookupStateRef"/></summary>
        ...
        public static LLVMOrcLookupStateRef FromABI(nint abiValue) => new( abiValue );

        private LLVMOrcLookupStateRef(nint p)
        {
            Handle = p;
        }
