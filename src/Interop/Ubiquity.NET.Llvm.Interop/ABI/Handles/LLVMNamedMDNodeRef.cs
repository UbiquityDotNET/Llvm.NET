// -----------------------------------------------------------------------
// <copyright file="LLVMNamedMDNodeRef.cs" company="Ubiquity.NET Contributors">
...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    /// </note>
    /// </remarks>
    [NativeMarshalling( typeof( ContextHandleMarshaller<LLVMNamedMDNodeRef> ) )]
    public readonly record struct LLVMNamedMDNodeRef
        : IContextHandle<LLVMNamedMDNodeRef>
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMNamedMDNodeRef"/></summary>
        ...
        public static LLVMNamedMDNodeRef FromABI(nint abiValue) => new( abiValue );

        private LLVMNamedMDNodeRef(nint p)
        {
            Handle = p;
        }
