// -----------------------------------------------------------------------
// <copyright file="LLVMTargetLibraryInfoRef.cs" company="Ubiquity.NET Contributors">
...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    /// </note>
    /// </remarks>
    [NativeMarshalling( typeof( ContextHandleMarshaller<LLVMTargetLibraryInfoRef> ) )]
    public readonly record struct LLVMTargetLibraryInfoRef
        : IContextHandle<LLVMTargetLibraryInfoRef>
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMTargetLibraryInfoRef"/></summary>
        ...
        public static LLVMTargetLibraryInfoRef FromABI(nint abiValue) => new( abiValue );

        private LLVMTargetLibraryInfoRef(nint p)
        {
            Handle = p;
        }
