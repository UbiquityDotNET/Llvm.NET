// -----------------------------------------------------------------------
// <copyright file="LLVMJITEventListenerRef.cs" company="Ubiquity.NET Contributors">
...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    /// </note>
    /// </remarks>
    [NativeMarshalling( typeof( ContextHandleMarshaller<LLVMJITEventListenerRef> ) )]
    public readonly record struct LLVMJITEventListenerRef
        : IContextHandle<LLVMJITEventListenerRef>
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMJITEventListenerRef"/></summary>
        ...
        public static LLVMJITEventListenerRef FromABI(nint abiValue) => new( abiValue );

        private LLVMJITEventListenerRef(nint p)
        {
            Handle = p;
        }
