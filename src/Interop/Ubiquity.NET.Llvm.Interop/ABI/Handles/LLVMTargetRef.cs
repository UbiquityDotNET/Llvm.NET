// -----------------------------------------------------------------------
// <copyright file="LLVMTargetRef.cs" company="Ubiquity.NET Contributors">
...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    /// </note>
    /// </remarks>
    [NativeMarshalling( typeof( ContextHandleMarshaller<LLVMTargetRef> ) )]
    public readonly record struct LLVMTargetRef
        : IContextHandle<LLVMTargetRef>
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMTargetRef"/></summary>
        ...
        public static LLVMTargetRef FromABI(nint abiValue) => new( abiValue );

        private LLVMTargetRef(nint p)
        {
            Handle = p;
        }
