// -----------------------------------------------------------------------
// <copyright file="LLVMOrcIRTransformLayerRef.cs" company="Ubiquity.NET Contributors">
...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    /// </note>
    /// </remarks>
    [NativeMarshalling( typeof( ContextHandleMarshaller<LLVMOrcIRTransformLayerRef> ) )]
    public readonly record struct LLVMOrcIRTransformLayerRef
        : IContextHandle<LLVMOrcIRTransformLayerRef>
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMOrcIRTransformLayerRef"/></summary>
        ...
        public static LLVMOrcIRTransformLayerRef FromABI(nint abiValue) => new( abiValue );

        private LLVMOrcIRTransformLayerRef(nint p)
        {
            Handle = p;
        }
