...
namespace Ubiquity.NET.Llvm.Interop
{
        ...
        : IContextHandle<LLVMOrcIRTransformLayerRef>
    {
        ...
        public LLVMOrcIRTransformLayerRef ThrowIfInvalid(
            string message = "",
        ...
        public static LLVMOrcIRTransformLayerRef Zero => FromABI(nint.Zero);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMOrcIRTransformLayerRef value) => value.Handle;
