// -----------------------------------------------------------------------
// <copyright file="LLVMAttributeRef.cs" company="Ubiquity.NET Contributors">
...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    /// </note>
    /// </remarks>
    [NativeMarshalling( typeof( ContextHandleMarshaller<LLVMAttributeRef> ) )]
    public readonly record struct LLVMAttributeRef
        : IContextHandle<LLVMAttributeRef>
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMAttributeRef"/></summary>
        ...
        public static LLVMAttributeRef FromABI(nint abiValue) => new( abiValue );

        private LLVMAttributeRef(nint p)
        {
            Handle = p;
        }
