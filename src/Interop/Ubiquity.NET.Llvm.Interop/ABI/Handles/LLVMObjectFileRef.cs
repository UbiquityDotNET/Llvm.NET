// -----------------------------------------------------------------------
// <copyright file="LLVMObjectFileRef.cs" company="Ubiquity.NET Contributors">
...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    public class LLVMObjectFileRef
        : LlvmObjectRef
    {
        /// <summary>Initializes an instance of <see cref="LLVMObjectFileRef"/> with default values</summary>
        public LLVMObjectFileRef()
            : base( ownsHandle: true )
        {
        }

        /// <summary>Initializes an instance of <see cref="LLVMObjectFileRef"/></summary>
        ...
        public LLVMObjectFileRef(nint handle, bool owner)
            : base( owner )
        {
            SetHandle( handle );
        }
        ...
        public static LLVMObjectFileRef Zero { get; } = new LLVMObjectFileRef( nint.Zero, false );
        ...
        protected override bool ReleaseHandle()
        {
            ...
            static extern void LLVMDisposeObjectFile(nint p);
        }
    }
}
