// -----------------------------------------------------------------------
// <copyright file="LLVMOrcSymbolStringPoolRef.cs" company="Ubiquity.NET Contributors">
...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    /// </note>
    /// </remarks>
    [NativeMarshalling( typeof( ContextHandleMarshaller<LLVMOrcSymbolStringPoolRef> ) )]
    public readonly record struct LLVMOrcSymbolStringPoolRef
        : IContextHandle<LLVMOrcSymbolStringPoolRef>
    {
        ...
        private LLVMOrcSymbolStringPoolRef(nint p)
        {
            Handle = p;
        }
