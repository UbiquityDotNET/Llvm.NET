// -----------------------------------------------------------------------
// <copyright file="LLVMOrcObjectLinkingLayerRef.cs" company="Ubiquity.NET Contributors">
...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    /// </note>
    /// </remarks>
    [NativeMarshalling( typeof( ContextHandleMarshaller<LLVMOrcObjectLinkingLayerRef> ) )]
    public readonly record struct LLVMOrcObjectLinkingLayerRef
        : IContextHandle<LLVMOrcObjectLinkingLayerRef>
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMOrcObjectLinkingLayerRef"/></summary>
        ...
        public static LLVMOrcObjectLinkingLayerRef FromABI(nint abiValue) => new( abiValue );

        private LLVMOrcObjectLinkingLayerRef(nint p)
        {
            Handle = p;
        }
