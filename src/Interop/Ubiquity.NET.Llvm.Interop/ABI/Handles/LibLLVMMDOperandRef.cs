...
namespace Ubiquity.NET.Llvm.Interop
{
        ...
        : IContextHandle<LibLLVMMDOperandRef>
    {
        ...
        public LibLLVMMDOperandRef ThrowIfInvalid(
            string message = "",
        ...
        public static LibLLVMMDOperandRef Zero => FromABI(nint.Zero);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LibLLVMMDOperandRef value) => value.Handle;
