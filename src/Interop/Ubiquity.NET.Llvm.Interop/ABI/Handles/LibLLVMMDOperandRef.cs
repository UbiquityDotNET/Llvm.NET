// -----------------------------------------------------------------------
// <copyright file="LibLLVMMDOperandRef.cs" company="Ubiquity.NET Contributors">
...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    /// </note>
    /// </remarks>
    [NativeMarshalling( typeof( ContextHandleMarshaller<LibLLVMMDOperandRef> ) )]
    public readonly record struct LibLLVMMDOperandRef
        : IContextHandle<LibLLVMMDOperandRef>
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LibLLVMMDOperandRef"/></summary>
        ...
        public static LibLLVMMDOperandRef FromABI(nint abiValue) => new( abiValue );

        private LibLLVMMDOperandRef(nint p)
        {
            Handle = p;
        }
