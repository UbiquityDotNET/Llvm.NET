...
namespace Ubiquity.NET.Llvm.Interop
{
        ...
        : IContextHandle<LLVMBasicBlockRef>
    {
        ...
        public LLVMBasicBlockRef ThrowIfInvalid(
            string message = "",
        ...
        public static LLVMBasicBlockRef Zero => FromABI(nint.Zero);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMBasicBlockRef value) => value.Handle;
