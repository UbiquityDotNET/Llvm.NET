// -----------------------------------------------------------------------
// <copyright file="LLVMBasicBlockRef.cs" company="Ubiquity.NET Contributors">
...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    /// </note>
    /// </remarks>
    [NativeMarshalling( typeof( ContextHandleMarshaller<LLVMBasicBlockRef> ) )]
    public readonly record struct LLVMBasicBlockRef
        : IContextHandle<LLVMBasicBlockRef>
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMBasicBlockRef"/></summary>
        ...
        public static LLVMBasicBlockRef FromABI(nint abiValue) => new( abiValue );

        private LLVMBasicBlockRef(nint p)
        {
            Handle = p;
        }
