...
namespace Ubiquity.NET.Llvm.Interop
{
        ...
        : IContextHandle<LLVMDiagnosticInfoRef>
    {
        ...
        public LLVMDiagnosticInfoRef ThrowIfInvalid(
            string message = "",
        ...
        public static LLVMDiagnosticInfoRef Zero => FromABI(nint.Zero);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMDiagnosticInfoRef value) => value.Handle;
