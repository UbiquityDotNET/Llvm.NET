// -----------------------------------------------------------------------
// <copyright file="LLVMDiagnosticInfoRef.cs" company="Ubiquity.NET Contributors">
...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    /// </note>
    /// </remarks>
    [NativeMarshalling( typeof( ContextHandleMarshaller<LLVMDiagnosticInfoRef> ) )]
    public readonly /*ref*/ record struct LLVMDiagnosticInfoRef
        : IContextHandle<LLVMDiagnosticInfoRef>
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMDiagnosticInfoRef"/></summary>
        ...
        public static LLVMDiagnosticInfoRef FromABI(nint abiValue) => new( abiValue );

        private LLVMDiagnosticInfoRef(nint p)
        {
            Handle = p;
        }
