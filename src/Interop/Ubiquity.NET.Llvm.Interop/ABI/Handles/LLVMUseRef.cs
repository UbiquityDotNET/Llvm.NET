// -----------------------------------------------------------------------
// <copyright file="LLVMUseRef.cs" company="Ubiquity.NET Contributors">
...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    /// </note>
    /// </remarks>
    [NativeMarshalling( typeof( ContextHandleMarshaller<LLVMUseRef> ) )]
    public readonly record struct LLVMUseRef
        : IContextHandle<LLVMUseRef>
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMUseRef"/></summary>
        ...
        public static LLVMUseRef FromABI(nint abiValue) => new( abiValue );

        private LLVMUseRef(nint p)
        {
            Handle = p;
        }
