// -----------------------------------------------------------------------
// <copyright file="LLVMOrcExecutionSessionRef.cs" company="Ubiquity.NET Contributors">
...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    /// </note>
    /// </remarks>
    [NativeMarshalling( typeof( ContextHandleMarshaller<LLVMOrcExecutionSessionRef> ) )]
    public readonly record struct LLVMOrcExecutionSessionRef
        : IContextHandle<LLVMOrcExecutionSessionRef>
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMOrcExecutionSessionRef"/></summary>
        ...
        public static LLVMOrcExecutionSessionRef FromABI(nint abiValue) => new( abiValue );

        private LLVMOrcExecutionSessionRef(nint p)
        {
            Handle = p;
        }
