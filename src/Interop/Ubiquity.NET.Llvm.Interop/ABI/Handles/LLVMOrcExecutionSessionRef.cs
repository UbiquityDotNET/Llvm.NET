...
namespace Ubiquity.NET.Llvm.Interop
{
        ...
        : IContextHandle<LLVMOrcExecutionSessionRef>
    {
        ...
        public LLVMOrcExecutionSessionRef ThrowIfInvalid(
            string message = "",
        ...
        public static LLVMOrcExecutionSessionRef Zero => FromABI(nint.Zero);

        /// <summary>Gets the handle as an <see cref="nint"/> suitable for passing to native code</summary>
        /// <param name="value">Handle to convert</param>
        /// <returns>The handle as an <see cref="nint"/></returns>
        public static implicit operator nint(LLVMOrcExecutionSessionRef value) => value.Handle;
