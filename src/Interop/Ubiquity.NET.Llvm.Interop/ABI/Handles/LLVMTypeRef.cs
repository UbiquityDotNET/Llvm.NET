// -----------------------------------------------------------------------
// <copyright file="LLVMTypeRef.cs" company="Ubiquity.NET Contributors">
...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    /// </note>
    /// </remarks>
    [NativeMarshalling( typeof( ContextHandleMarshaller<LLVMTypeRef> ) )]
    public readonly record struct LLVMTypeRef
        : IContextHandle<LLVMTypeRef>
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMTypeRef"/></summary>
        ...
        public static LLVMTypeRef FromABI(nint abiValue) => new( abiValue );

        private LLVMTypeRef(nint p)
        {
            Handle = p;
        }
