// -----------------------------------------------------------------------
// <copyright file="LLVMValueRef.cs" company="Ubiquity.NET Contributors">
...
namespace Ubiquity.NET.Llvm.Interop
{
    ...
    /// </note>
    /// </remarks>
    [NativeMarshalling( typeof( ContextHandleMarshaller<LLVMValueRef> ) )]
    public readonly record struct LLVMValueRef
        : IContextHandle<LLVMValueRef>
    {
        ...
        /// <summary>Interface defined factory for an instance of <see cref="LLVMValueRef"/></summary>
        ...
        public static LLVMValueRef FromABI(nint abiValue) => new( abiValue );

        private LLVMValueRef(nint p)
        {
            Handle = p;
        }
