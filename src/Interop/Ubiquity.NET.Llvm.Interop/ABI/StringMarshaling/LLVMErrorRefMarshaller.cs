...
namespace Ubiquity.NET.Llvm.Interop.ABI.StringMarshaling
{
    ...
    [CustomMarshaller( typeof( LLVMErrorRef ), MarshalMode.Default, typeof(LLVMErrorRefMarshaller) )]
    public static class LLVMErrorRefMarshaller
    {
        ...
        public static LLVMErrorRef ConvertToManaged( nint abiValue )
        {
            ...
            return LLVMErrorRef.FromABI( abiValue );
        }

        [SuppressMessage( "Design", "CA1000:Do not declare static members on generic types", Justification = "Needed for marshalling" )]
        public static nint ConvertToUnmanaged( LLVMErrorRef managed )
        {
