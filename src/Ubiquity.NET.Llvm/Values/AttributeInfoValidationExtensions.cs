...
namespace Ubiquity.NET.Llvm.Values
{
    ...
    public static class AttributeInfoValidationExtensions
    {
        ...
        /// <param name="name">Name of the attribute info [Normally generated by compiler]</param>
            ...
            )
        {
            ...
            {
                throw new ArgumentException($"Attribute info indicates the wrong kind of argument. [expected: {kind}; got: {self.ArgKind}]", nameof(kind));
            }
        }
